...
<body class="bg-dark">
      ...
      <div class="modal-content">
        ...
        <form action="" method="post">
          <div class="modal-body">
            ...
            <input type="hidden" name="id" class="id-ol">
  ...
  <div class="modal fade" id="modalUploadPdf" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title" id="exampleModalLabel">Edit Status</h5>
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <input type="hidden" name="id" class="id-ol">
            <input type="hidden" name="proses" value="uploadPdf">
            <div class="form-group">
  ...
  <?php $notif = isset($_GET['notif']) ? $_GET['notif'] : null; ?>
    ...
    $(document).ready(function() {
      ...
      switch (notif) {
        ...
        case 'pdf-tersedia':
          Swal.fire(
            'Error!',
            'Hasil sudah tersedia, Mohon menghapus hasil terlebih dahulu!',
            'error'
          )
          break;
